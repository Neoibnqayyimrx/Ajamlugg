  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // NOTE: "sky" is already a default Tailwind color with these exact values.
        // If you need to override it, uncomment below; otherwise it inherits from Tailwind.
        // sky: {
        //   DEFAULT: "#3B82F6",
        //   50:  "#EFF6FF",
        //   100: "#DBEAFE",
        ...
        // "Warm" palette — the hex values already live as local `C = {...}`
        // objects on Home/Learn/Profile. Registered here as named tokens
        // (e.g. `bg-warm-bg` instead of `bg-[#FAF6F0]`) so new screens can
        // use them directly; existing screens migrate opportunistically.
        "warm-bg": "#FAF6F0",
        "warm-surface": "#FFFFFF",
        "warm-green": "#1B6B3A",
        "warm-green-light": "#E8F5EE",
        "warm-green-mid": "#2D8653",
        "warm-gold": "#D4A017",
        "warm-gold-light": "#FDF6E3",
        "warm-text": "#1A1A1A",
        "warm-text-sub": "#6B7280",
        "warm-border": "#EDE8E0",
        "warm-danger": "#DC2626",
        "warm-streak": "#E8511A",
      ...
      fontSize: {
        ...
        // NOTE: For React Native + NativeWind, lineHeight can be px or unitless.
        // Using px here for precise design-system matching.
